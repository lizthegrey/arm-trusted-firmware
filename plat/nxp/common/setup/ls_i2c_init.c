/*
 * Copyright 2024-2025 SolidRun Ltd.
 *
 * SPDX-License-Identifier: BSD-3-Clause
 *
 * LX2160A Chip Errata A-010650 workaround:
 * Flush I2C buses by toggling SCL 9 times via GPIO before DDR init,
 * in case a slave device is holding SDA low after a mid-transaction reset.
 */
